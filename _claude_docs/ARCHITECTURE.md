...
- **기본 suite** (`runner.default_suite`, 8개): `SingleManagerClone(Buffett)`, `SingleManagerClone(Druckenmiller)`, `ConsensusTopK(3,20)`, `ScoreTopK(20)`, `ConvictionFollow(10)`, `NewBuyOnly(2,15)`, `Ensemble`(Buffett 0.4 / ScoreTopK 0.4 / ConsensusTopK 0.2), `MultiManager`(Buffett·Ackman·Tepper, top 15).
